...
addPluginScript('<link rel="stylesheet" href="' . FULLWEBPATH . "/" . USER_PLUGIN_FOLDER . 'GoogleCheckout/GoogleCheckout.css" type="text/css" />');
...
addPluginScript('<link rel="stylesheet" href="' . FULLWEBPATH . "/" . USER_PLUGIN_FOLDER . 'GoogleCheckout/GoogleCart' . $cartloc . '.css" type="text/css" />');
...
function googleCheckoutTesting() {
	addPluginScript('<script type="text/javascript" src="' . FULLWEBPATH . "/" . USER_PLUGIN_FOLDER . 'GoogleCheckout/GoogleCartPostToSandBox.js"></script>');
}
