...
class cacheHeader_options {
	...
	function getOptionsSupported() {
		return array(	gettext('Store') => array('key' => 'cacheHeader_store', 'type' => OPTION_TYPE_CHECKBOX,
									...
									gettext('Pre-check') => array('key' => 'cacheHeader_pre-check', 'type' => OPTION_TYPE_TEXTBOX,
										'order'=> 3,
										'desc' => gettext('cache "pre-check" value')),
									gettext('Post-check') => array('key' => 'cacheHeader_post-check', 'type' => OPTION_TYPE_TEXTBOX,
										'order'=> 4,
										'desc' => gettext('cache "post-check" value')),
									gettext('Max-age') => array('key' => 'cacheHeader_max-age', 'type' => OPTION_TYPE_TEXTBOX,
										'order'=> 5,
