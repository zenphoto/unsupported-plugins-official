...
function upload_head() {
	?>
	<link rel="stylesheet" href="<?php echo WEBPATH.'/'.USER_PLUGIN_FOLDER;?>/uploader_flash/uploadify.css" type="text/css" />
	...
	<script type="text/javascript" src="<?php echo WEBPATH.'/'.USER_PLUGIN_FOLDER;?>/uploader_flash/jquery.uploadify.js"></script>
	<script type="text/javascript" src="<?php echo WEBPATH.'/'.USER_PLUGIN_FOLDER;?>/uploader_flash/swfobject.js"></script>
		...
		if (FlashDetect.installed) {
			$(document).ready(function() {
				$('#fileUpload').uploadify({
					'uploader': '<?php echo WEBPATH.'/'.USER_PLUGIN_FOLDER;?>/uploader_flash/uploadify.swf',
					'cancelImg': 'images/fail.png',
					'script': '<?php echo WEBPATH.'/'.USER_PLUGIN_FOLDER;?>/uploader_flash/uploader.php',
					'scriptData': {
					...
					<?php echo $rollover; ?>
					'checkScript': '<?php echo WEBPATH.'/'.USER_PLUGIN_FOLDER;?>/uploader_flash/check.php',
					'displayData': 'speed',
					'simUploadLimit': 3,
