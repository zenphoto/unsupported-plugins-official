...
class viewer_size_image_options {
	...
	function getOptionsSupported() {
		return array(gettext('Image sizes allowed') => array(
						'key' => 'viewer_size_image_sizes',
				...
				gettext('Selector') => array(
						'key' => 'viewer_size_image_radio',
						'type' => OPTION_TYPE_RADIO,
						'buttons' => array(
								gettext('Radio buttons') => 2,
								gettext('Drop-down') => 1),
						'desc' => gettext('Choose the kind of selector to be presented the viewer.')),
				gettext('Default size') => array(
						'key' => 'viewer_size_image_default',
