...
class jcarousel {
	...
	function getOptionsSupported() {
		global $_zp_gallery;
		$options = array(gettext('Thumbs number') => array(
						'key' => 'jcarousel_scroll',
	...
	static function themeJS() {
		...
		if (file_exists($css)) {
			...
			$css = WEBPATH . '/' . USER_PLUGIN_FOLDER . '/jcarousel_thumb_nav/jcarousel.css';
		}
		?>
		<script>
			(function ($) {
		...
		<script type="text/javascript" src="<?php echo WEBPATH . '/' . USER_PLUGIN_FOLDER; ?>/jcarousel_thumb_nav/jquery.jcarousel.pack.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo WEBPATH . '/' . USER_PLUGIN_FOLDER; ?>/jcarousel_thumb_nav/jquery.jcarousel.css" />
