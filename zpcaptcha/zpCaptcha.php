...
class zpCaptcha extends _zp_captcha {
	...
	function getOptionsSupported() {
		...
		$options = array(
				gettext('Hash key') => array(
						'key' => 'zenphoto_captcha_key',
	...
	function getCaptcha($prompt) {
		...
		$html = '<label for="code" class="captcha_label">' . $prompt . '</label><img id="captcha" src="' . WEBPATH . '/' . USER_PLUGIN_FOLDER . '/zpCaptcha/c.php?i=' . $cypher . '" alt="Code" />';
