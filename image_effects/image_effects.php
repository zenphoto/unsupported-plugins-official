...
class image_effects {
	...
	function getOptionsSupported() {
		...
		if (count($list) == 0) {
			return array(gettext('No effects') => array(
							'key' => 'image_effect_none',
		...
		$std = array(gettext('Images (standard)') => array(
						'key' => 'image_std_images',
